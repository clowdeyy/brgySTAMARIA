...
Public Class crResidentlist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sta.Maria_Business_and_Record_Management_System.crResidentlist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrResidentlist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crResidentlist = New crResidentlist()
        rpt.Site = Me.Site
        Return rpt
    End Function
