...
Public Class crHouseholdList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sta.Maria_Business_and_Record_Management_System.crHouseholdList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrHouseholdList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crHouseholdList = New crHouseholdList()
        rpt.Site = Me.Site
        Return rpt
    End Function
