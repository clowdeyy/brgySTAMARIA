...
Public Class crRClearance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sta.Maria_Business_and_Record_Management_System.crRClearance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRClearance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRClearance = New crRClearance()
        rpt.Site = Me.Site
        Return rpt
    End Function
