...
Public Class cRBClearance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sta.Maria_Business_and_Record_Management_System.cRBClearance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcRBClearance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cRBClearance = New cRBClearance()
        rpt.Site = Me.Site
        Return rpt
    End Function
