...
Public Class crBusinesslist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sta.Maria_Business_and_Record_Management_System.crBusinesslist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrBusinesslist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crBusinesslist = New crBusinesslist()
        rpt.Site = Me.Site
        Return rpt
    End Function
