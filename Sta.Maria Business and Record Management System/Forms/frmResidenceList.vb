Public Class frmResidenceList
    ...
    Sub loadResidence()
        ...
        Try
            DbConnect()
            Dim query As String = "SELECT res_id, res_name, res_status, res_sex, street_name FROM residence,streets where residence.street_id = streets.street_ID AND is_deceased = 'no' order by res_name"
            ExecuteQuery(query)
            Dim i As Integer = 0
